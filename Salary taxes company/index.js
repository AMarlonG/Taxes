...
const vacation = {
  ...
  payment() {
    return noDecimals(
      monthlySalary +
        salary * this.percentOfIncome -
        (monthlySalary / this.daysWithPay) * this.daysAllowed
    );
  },
};
...
const totalCosts = noDecimals(
  vacationPayment +
    salaryMinusVacationPayment +
    pensionPayment +
    employeeTax +
    pensionTax
);
