...
const minIncomeForBenefits = oneG * 0.75; // Minimum income for receiving benefits
...
const vacationInfo = {
  ...
  payment() {
    return noDecimals(
      monthlyIncome +
        myIncome * this.percentOfIncome -
        (monthlyIncome / this.daysWithPay) * this.daysAllowed
    );
  },
};
...
// Tax percent
const finalTaxPercentOfGrossIncome = noDecimals(
  (allTaxesTotal * 100) / myIncome
);
